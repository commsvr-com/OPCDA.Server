...
Key Name:          HKEY_CLASSES_ROOT\AppID\CASOpcDaWrapper.exe
Class Name:        <NO CLASS>
Last Write Time:   2017-07-28 - 22:02
Value 0
  Name:            <NO NAME>
...
### <ApplicationDescription>CAS CommServer OPC DA Server</ApplicationDescription> <!--Used to name DCOM component-->

### <AppID>{B41C9D1F-28AC-41cb-9DCD-CEBE1FC86210}</AppID> <!--Used to register application  component-->
